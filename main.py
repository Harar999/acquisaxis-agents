...
SLACK_WEBHOOK_PERFORMANCE = os.getenv("SLACK_WEBHOOK_PERFORMANCE")
SLACK_WEBHOOK_VIRAL = os.getenv("SLACK_WEBHOOK_VIRAL")
SLACK_WEBHOOK_SALES = os.getenv("SLACK_WEBHOOK_SALES")
